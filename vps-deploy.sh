...
# GachaBuild VPS Deployment Script
...
echo -e "${BLUE}🚀 Starting GachaBuild VPS Deployment${NC}"
echo "=============================================="
...
print_status "Checking out feature/content-v1 branch..."
git checkout feature/content-v1
...
cat > /etc/systemd/system/gachabuild.service << EOF
[Unit]
...
systemctl enable gachabuild.service
...
BACKUP_DIR="/root/backups/gachabuild"
